...
impl<'a> TokenKind<'a> {
    pub fn string_type(&self) -> &'static str {
        match self {
            ...
            TokenKind::Dayofyear => "dayofyear",
            TokenKind::Decimal => "decimal",
            TokenKind::Declare => "declare",
            TokenKind::Degrees => "degrees",
            TokenKind::Default => "default",
            TokenKind::Delete => "delete",
            TokenKind::DenseRank => "denserank",
            TokenKind::Desc => "desc",
            ...
            TokenKind::FirstValue => "firstvalue",
            ...
            TokenKind::Row => "row",
            TokenKind::Rowid => "rowid",
            TokenKind::Rows => "rows",
            TokenKind::RowNumber => "rownumber",
            ...
            TokenKind::Unbounded => "unbounded",
            TokenKind::Uncommitted => "uncommitted",
